...
#     # print(22222222,scored_chunks[:top_k])
...
#                 print("PAGE TEXT SAMPLE:", page_text if page_text else "NO TEXT")
#                 if page_text:
...
# 🔹 Global storage (acts like memory)
...
# ==============================
# 7️⃣ INITIALIZE ON STARTUP
# ==============================
def initialize_doc_system():
